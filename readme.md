...
![Register Page](./images/register.png)
 ![alt text](register.png) ![alt text](login.png) ![alt text](home.png) ![alt text](editProfile.png) ![alt text](posts.png) ![alt text](createPost.png) ![alt text](resHome.png) ![alt text](search.png)![alt text](userProfile.png)